...
import './LongHaulTransportation.css';

const LongHaulTransportation = () => {
  const features = [
    {
      icon: <LocalShippingIcon sx={{ fontSize: 40, color: '#3B82F6' }} />,
      title: 'Cross-Country Delivery',
      description: 'Reliable long-distance transportation services across North America.'
    },
    {
    ...
    },
    {
      ...
      description: 'Advanced security measures to protect your cargo during transit.'
    },
    {
...
export default LongHaulTransportation; 